  ...
  return (
    <section className="contact section-white" id="contact">
      ...
      <div className="map" aria-label="HHA buyer advisory service map graphic">
        ...
        <article><img src={images.property1} alt="Premium property" /><div><strong>HHA Buyer Advisory</strong><small>Independent buyer specialists</small><button onClick={() => window.location.href = `mailto:${CONTACT_EMAIL}`}>Email HHA</button></div></article>
      </div>
    </section>
  );
}
